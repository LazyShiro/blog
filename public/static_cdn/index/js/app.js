let e = {
    ...
    statics: "/",
    favicon: {
        normal: "http://resource.an0nymou5.com/blog/asset/index/images/favicon.ico",
        hidden: "http://resource.an0nymou5.com/blog/asset/index/images/failure.ico"
    },
    darkmode: false,
    auto_scroll: true,
    js: {
        valine: "http://resource.an0nymou5.com/blog/asset/index/js/MiniValine.min.js",
    ...
    css: {
        valine: "http://resource.an0nymou5.com/blog/asset/index/css/comment.css",
    ...
    W = window.location.href, Y, X = lozad("img, [data-background-image]", {
        ...
        document.addEventListener("visibilitychange", function () {
            switch (document.visibilityState) {
                case"hidden":
                    u('[rel="icon"]').attr("href", e.favicon.hidden);
                    document.title = LOCAL.favicon.hide;
                    if (e.loader.switch) F.show();
                    clearTimeout(b);
                    break;
                case"visible":
                    u('[rel="icon"]').attr("href", e.favicon.normal);
