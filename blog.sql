...
CREATE TABLE `data_news_category`  (
  ...
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '标签状态(1使用,0禁用)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-文章-分类' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_news_item`  (
  ...
  `num_like` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章点赞数',
  `num_read` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章阅读数',
  `num_collect` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章收藏数',
  `num_comment` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章评论数',
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '文章状态(1使用,0禁用)',
...
CREATE TABLE `data_news_relation`  (
  `news_id` bigint NULL DEFAULT 0 COMMENT '文章id',
  `type` tinyint NULL DEFAULT 0 COMMENT '关系类型 详见枚举类',
  `object_id` bigint NULL DEFAULT 0 COMMENT '对象id'
...
CREATE TABLE `data_news_x_collect`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` bigint UNSIGNED NULL DEFAULT 0 COMMENT '用户UID',
  `type` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '记录类型(1收藏,2点赞,3历史)',
  `code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '文章编号',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-文章-标记' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-文章-评论' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_payment`  (
  ...
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '支付状态(1使用,0禁用)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-支付-通道' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_payment_item`  (
  ...
  `payment_id` bigint NULL DEFAULT 0 COMMENT '支付编号',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-支付-记录' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `from` bigint UNSIGNED NULL DEFAULT 0 COMMENT '邀请者MID',
  ...
  `base_age` bigint NULL DEFAULT 0 COMMENT '用户年龄',
  ...
  `coin_total` bigint NULL DEFAULT 0 COMMENT '金币数量',
  `coin_used` bigint NULL DEFAULT 0 COMMENT '金币已用',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '用户状态(1正常,0已拉黑)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-用户-记录' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user_address`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` bigint UNSIGNED NULL DEFAULT 0 COMMENT '用户UID',
  `type` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '地址类型(0普通,1默认)',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-用户-地址' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user_coin_item`  (
  ...
  `number` bigint NULL DEFAULT 0 COMMENT '奖励数量',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据-用户-金币-获得' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user_coin_used`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` bigint UNSIGNED NULL DEFAULT 0 COMMENT '用户UID',
  `from` bigint NULL DEFAULT 0 COMMENT '来自MID',
  `type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '记录类型',
  `target` bigint UNSIGNED NULL DEFAULT 0 COMMENT '目标ID',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '记录名称',
  `number` bigint NULL DEFAULT 0 COMMENT '奖励数量',
  `date` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '记录日期',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据-用户-金币-消费' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user_message`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '短信类型',
  ...
  `status` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '短信状态(0失败,1成功)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统-用户-短信' ROW_FORMAT = COMPACT;
...
CREATE TABLE `data_user_token`  (
  ...
  `time` bigint NULL DEFAULT 0 COMMENT '有效时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据-用户-认证' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_goods`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `cate` bigint NULL DEFAULT 0 COMMENT '商品分类',
  ...
  `stock_total` bigint NULL DEFAULT 0 COMMENT '库存统计',
  `stock_sales` bigint NULL DEFAULT 0 COMMENT '销售统计',
  `stock_virtual` bigint UNSIGNED NULL DEFAULT 0 COMMENT '虚拟销量',
  ...
  `num_comment` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章评论数',
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '商品状态(1使用,0禁用)',
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '删除状态(0未删,1已删)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-商品-内容' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_goods_cate`  (
  ...
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '使用状态',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-商品-分类' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_goods_item`  (
  ...
  `stock_sales` bigint UNSIGNED NULL DEFAULT 0 COMMENT '销售数量',
  `stock_total` bigint UNSIGNED NULL DEFAULT 0 COMMENT '商品库存',
  ...
  `number_virtual` bigint UNSIGNED NULL DEFAULT 0 COMMENT '虚拟销量',
  `number_express` bigint UNSIGNED NULL DEFAULT 1 COMMENT '计件数量',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '商品状态',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城-商品-规格' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-商品-标签' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_goods_stock`  (
  ...
  `goods_stock` bigint UNSIGNED NULL DEFAULT 0 COMMENT '入库数量',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '数据状态(1使用,0禁用)',
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '删除状态(0未删,1已删)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_data_news_item_status`(`status`) USING BTREE,
  INDEX `idx_data_news_item_deleted`(`deleted`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-商品-库存' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_order`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `uid` bigint UNSIGNED NULL DEFAULT 0 COMMENT '用户编号',
  `from` bigint UNSIGNED NULL DEFAULT 0 COMMENT '推荐用户',
  ...
  `payment_status` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '实际支付状态',
  ...
  `cancel_status` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '订单取消状态',
  ...
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '订单状态(0已取消,1预订单,2待支付,3待发货,4待签收,5已完成)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(0未删,1已删)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-订单-内容' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_order_item`  (
  ...
  `truck_count` bigint UNSIGNED NULL DEFAULT 0 COMMENT '快递计费基数',
  `truck_tcode` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '快递邮费模板',
  `stock_sales` bigint UNSIGNED NULL DEFAULT 1 COMMENT '购买商品数量',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '商品状态(1使用,0禁用)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(0未删,1已删)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-订单-商品' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_order_send`  (
  ...
  `template_count` bigint UNSIGNED NULL DEFAULT 0 COMMENT '快递计费基数',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-订单-配送' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_order_service`  (
  ...
  `num_comment` bigint UNSIGNED NULL DEFAULT 0 COMMENT '文章评论数',
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '记录状态(1使用,0禁用)',
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '删除状态(0未删,1已删)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_data_news_item_status`(`status`) USING BTREE,
  INDEX `idx_data_news_item_deleted`(`deleted`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-订单-售后' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_truck_company`  (
  ...
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '状态(0.无效,1.有效)',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(1已删除,0未删除)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城-快递-公司' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_truck_region`  (
  ...
  `pid` int UNSIGNED NULL DEFAULT 0 COMMENT '上级PID',
  ...
  `level` tinyint NULL DEFAULT 0 COMMENT '区域层级',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4018 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城-快递-区域' ROW_FORMAT = COMPACT;
...
CREATE TABLE `shop_truck_template`  (
  ...
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '模板状态',
  `deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商城-快递-模板' ROW_FORMAT = COMPACT;
...
CREATE TABLE `system_auth`  (
  ...
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '权限状态(1使用,0禁用)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `system_auth_node`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `auth` bigint UNSIGNED NULL DEFAULT 0 COMMENT '角色',
...
-- ----------------------------
INSERT INTO `system_config` VALUES ('base', 'app_name', '胖子admin');
INSERT INTO `system_config` VALUES ('base', 'app_version', 'v2');
INSERT INTO `system_config` VALUES ('base', 'beian', '看着来');
INSERT INTO `system_config` VALUES ('base', 'miitbeian', '看着来');
INSERT INTO `system_config` VALUES ('base', 'site_copy', '看着来');
INSERT INTO `system_config` VALUES ('base', 'site_icon', '/upload/25/3b2e41a1cb8137bb27550f30a9fb62.png');
INSERT INTO `system_config` VALUES ('base', 'site_main_title', '主标题');
INSERT INTO `system_config` VALUES ('base', 'site_name', '网站名称');
INSERT INTO `system_config` VALUES ('base', 'site_sub_title', '副标题');
...
INSERT INTO `system_config` VALUES ('storage', 'qiniu_http_protocol', '');
...
CREATE TABLE `system_menu`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `pid` bigint UNSIGNED NULL DEFAULT 0 COMMENT '上级ID',
  ...
  `sort` int UNSIGNED NULL DEFAULT 0 COMMENT '排序权重',
  `status` tinyint UNSIGNED NULL DEFAULT 1 COMMENT '状态(0:禁用,1:启用)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_system_menu_status`(`status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 89 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统-菜单' ROW_FORMAT = COMPACT;
...
INSERT INTO `system_menu` VALUES (71, 68, '轮播图片管理', 'layui-icon layui-icon-carousel', '', 'data/config/slider', '', '_self', 996, 1, '2020-07-14 01:17:02');
...
INSERT INTO `system_menu` VALUES (89, 68, '友情链接管理', 'fa fa-users', '', 'data/friend/index', '', '_self', 995, 1, '2020-12-28 10:04:44');
...
CREATE TABLE `system_queue`  (
  ...
  `exec_pid` bigint NULL DEFAULT 0 COMMENT '执行进程',
  `exec_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '执行参数',
  `exec_time` bigint NULL DEFAULT 0 COMMENT '执行时间',
  ...
  `loops_time` bigint NULL DEFAULT 0 COMMENT '循环时间',
  `attempts` bigint NULL DEFAULT 0 COMMENT '执行次数',
...
CREATE TABLE `system_user`  (
  ...
  `login_num` bigint NULL DEFAULT 0 COMMENT '登录次数',
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '', ',,', '123456', 'test@gmail.com', '13888888888', '127.0.0.1', '2020-12-28 11:43:14', 50, '描述', '{\"github\":\"github.com\",\"music\":\"music.163.com\",\"weibo\":\"weibo.com\"}', 1, 0, 0, '2015-11-13 15:14:22');
...
CREATE TABLE `wechat_fans`  (
  ...
  `is_black` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '是否为黑名单状态',
  `subscribe` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '关注状态(0未关注,1已关注)',
  `nickname` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '用户昵称',
  `sex` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '用户性别(1男性,2女性,0未知)',
  ...
  `subscribe_time` bigint UNSIGNED NULL DEFAULT 0 COMMENT '关注时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-粉丝' ROW_FORMAT = COMPACT;
...
CREATE TABLE `wechat_fans_tags`  (
  ...
  `count` bigint UNSIGNED NULL DEFAULT 0 COMMENT '总数',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-标签' ROW_FORMAT = COMPACT;
...
CREATE TABLE `wechat_keys`  (
  ...
  `news_id` bigint UNSIGNED NULL DEFAULT NULL COMMENT '图文ID',
  `sort` bigint UNSIGNED NULL DEFAULT 0 COMMENT '排序字段',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-规则' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-素材' ROW_FORMAT = COMPACT;
...
CREATE TABLE `wechat_news`  (
  ...
  `is_deleted` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(0未删除,1已删除)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `create_by` bigint NULL DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_wechat_news_artcle_id`(`article_id`) USING BTREE,
  INDEX `index_wechat_news_media_id`(`media_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-图文' ROW_FORMAT = COMPACT;
...
CREATE TABLE `wechat_news_article`  (
  ...
  `show_cover_pic` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '显示封面(0不显示,1显示)',
  ...
  `read_num` bigint UNSIGNED NULL DEFAULT 0 COMMENT '阅读数量',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信-文章' ROW_FORMAT = COMPACT;
